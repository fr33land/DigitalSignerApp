		...
		public TokenListViewer(DigitalSignerApplet digitalSignerApplet) 
			{
				...
				treeModel = new DefaultTreeModel(new DefaultMutableTreeNode("Kortelių skaitytuvai"));
		        				...
		        				if(node.getUserObject() instanceof TokenObject)
		        					{
		        						...
		        						tokenObjectListDialog.setTitle(to.getObjectData().toString()+" objektų sąrašas");
