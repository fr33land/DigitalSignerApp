		...
		public ObjectDataDialog(TokenDataCertificateObject tdco)
			{
				...
				this.setTitle("Sertifikato duomenys");
				...
				tabbedPane.addTab("Setifikato pusės", subjMainPanel);
				
				subjectTableModel.addColumn("Identifikatorius");
				subjectTableModel.addColumn("Reikšmė");
				...
				issuerTableModel.addColumn("Identifikatorius");
				issuerTableModel.addColumn("Reikšmė");
				...
				tabbedPane.addTab("Setifikato duomenys", certificateScrollPane);
				certificateTableModel.addColumn("Identifikatorius");
				certificateTableModel.addColumn("Reikšmė");
